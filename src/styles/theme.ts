export const theme = {
  ...
  // Espaçamentos específicos da Lacrei Design System
  lacreiSpacing: {
    // Desktop
    desktop: {
      headerToElement: '48px',      // Header → qualquer elemento
      footerToElement: '64px',      // Footer → qualquer elemento
      headingToUnderline: '8px',    // Heading → underline
      headingToSubtitle: '16px',    // Heading → subtitle
      headingToElement: '32px',     // Heading → qualquer elemento
      textToText: '16px',           // Text → text
      textToInput: '32px',          // Text → inputs
      buttonToButton: '24px',       // Botão → botão
      buttonToElement: '32px',      // Botão → qualquer elemento
      cardToCard: '24px',           // Card → card
      sectionToSection: '48px',     // Seções de informações diferentes
    },
    // Mobile
    mobile: {
      headerToElement: '24px',      // Header → qualquer elemento
      footerToElement: '64px',      // Footer → qualquer elemento
      headingToElement: '24px',     // Heading → qualquer elemento
      textToInput: '24px',          // Text → inputs
      buttonToButton: '24px',       // Botão → botão
      buttonToElement: '32px',      // Botão → qualquer elemento
      cardToCard: '16px',           // Card → card
      sectionToSection: '40px',     // Seções de informações diferentes
    }
  },
  ...
  // Grid System da Lacrei Design System
  grid: {
    sm: {
      columns: 4,
      margin: '24px',
