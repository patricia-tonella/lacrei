...
export const ProfessionalsList: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (professionals.length === 0) {
      return (
        <EmptyState>
          <EmptyText>Nenhum profissional encontrado</EmptyText>
        </EmptyState>
      );
    }
            ...
            <AvailableSlots>
              ...
              <SlotsList>
                ...
                {professional.availableSlots.length > 3 && (
                  <SlotTag>
                    +{professional.availableSlots.length - 3} mais
                  </SlotTag>
                )}
              </SlotsList>
            </AvailableSlots>
    ...
    <ProfessionalsSection>
      <Container>
        <SectionHeader>
          ...
          <SectionSubtitle>
            Encontre profissionais qualificados e inclusivos para cuidar da sua
            saúde
          </SectionSubtitle>
        </SectionHeader>

        <SearchContainer>
          <label htmlFor='professional-search' style={{ display: 'none' }}>
          ...
          <SearchInput
            ...
            disabled={loading} // Dynamically set the disabled state
          />
