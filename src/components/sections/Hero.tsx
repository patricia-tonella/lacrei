...
const HeroSection = styled.section`
  ...
  background: linear-gradient(135deg, 
    #FF0000 0%, #FF8C00 16.67%, #FFFF00 33.33%, 
    #00FF00 50%, #0000FF 66.67%, #8B00FF 83.33%, #FF00FF 100%);
  overflow: hidden;
...
const HeroContent = styled.div`
  ...
  padding: ${({ theme }) => theme.lacreiSpacing.desktop.sectionToSection} ${({ theme }) => theme.grid.lg.margin};
  display: flex;
  ...
  @media (max-width: ${({ theme }) => theme.breakpoints.lg}) {
    ...
    padding: ${({ theme }) => theme.spacing[10]} ${({ theme }) => theme.grid.md.margin};
  }
  
  @media (max-width: ${({ theme }) => theme.breakpoints.md}) {
    max-width: ${({ theme }) => theme.grid.md.maxWidth};
    padding: ${({ theme }) => theme.lacreiSpacing.mobile.sectionToSection} ${({ theme }) => theme.grid.md.margin};
    text-align: center;
  }
  
  @media (max-width: ${({ theme }) => theme.breakpoints.sm}) {
    max-width: ${({ theme }) => theme.grid.sm.maxWidth};
    padding: ${({ theme }) => theme.spacing[6]} ${({ theme }) => theme.grid.sm.margin};
  }
  
  @media (min-width: ${({ theme }) => theme.breakpoints.xl}) {
    max-width: ${({ theme }) => theme.grid.xl.maxWidth};
    padding: ${({ theme }) => theme.lacreiSpacing.desktop.sectionToSection} ${({ theme }) => theme.grid.xl.margin};
  }
  
  @media (min-width: ${({ theme }) => theme.breakpoints['2xl']}) {
    max-width: ${({ theme }) => theme.grid['2xl'].maxWidth};
    padding: ${({ theme }) => theme.lacreiSpacing.desktop.sectionToSection} ${({ theme }) => theme.grid['2xl'].margin};
  }
`
